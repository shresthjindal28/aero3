...
export default function SignUpPage() {
  ...
  const imageClassName = `absolute inset-0 z-0 ${
    gender === "female" ? "object-cover" : "object-cover object-center"
  } opacity-80`;
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-md">
          <h1 className="text-3xl font-bold mb-2 text-center lg:text-left">
            {pendingVerification ? "Enter verification code" : "Create your account"}
          </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Use a strong, unique password. Avoid commonly used or compromised
                    passwords.
                  </p>
                </div>
                ...
                <Button
                  type="submit"
                  className="w-full bg-[#6c47ff] hover:bg-[#5a3bdb]"
