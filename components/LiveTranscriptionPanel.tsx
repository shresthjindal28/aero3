...
// Swapped Brain for Stethoscope for a more medical-specific icon
...
export function LiveTranscriptionPanel() {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-black/90 backdrop-blur-xl rounded-2xl border border-green-900/20 overflow-hidden shadow-2xl">
      {/* Header */}
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/20 bg-black">
        <div className="flex items-center gap-3">
          <div className="relative">
            {/* Changed to emerald */}
            <div className="absolute inset-0 bg-emerald-500 rounded-full blur-md animate-pulse" />
            {/* Changed to emerald/teal gradient */}
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            {/* Changed icon and color to emerald */}
      ...
      {/* Footer with metrics */}
      <div className="px-6 py-3 bg-black border-t border-gray-700/50 flex items-center justify-between">
        <div className="flex items-center gap-6 text-xs">
          {/* Changed all footer text to emerald */}
          <div className="flex items-center gap-2">
